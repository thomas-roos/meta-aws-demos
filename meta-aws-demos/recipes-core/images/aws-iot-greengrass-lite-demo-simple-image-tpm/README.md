...
The main difference it is support for a TPM module.
...
openssl req -new -provider tpm2 -propquery '?provider=tpm2'  -key "handle:0x81000002"     -subj "/CN=TPMThing" -out device.csr


scp -O root@192.168.0.188:/root/device.csr  .
